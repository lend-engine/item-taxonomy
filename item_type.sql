...
# Database: taxonomy
# Generation Time: 2024-06-02 11:10:04 +0000
# ************************************************************
...
VALUES
	...
	(24,NULL,'Luggage, Bags & Storage',NULL,''),
	(25,NULL,'Home',NULL,NULL),
	(26,25,'Kitchen & Dining',NULL,NULL),
	(27,26,'Kitchen utensils',NULL,NULL),
	(28,26,'Kitchen applicances',NULL,'Air fryers, toasters, kettles'),
	...
	(62,54,'Gardening Hand Tools',NULL,''),
	...
	(202,136,'Keyboards, Mice & Accessories',NULL,''),
	...
	(257,256,'Racquets - Generic',1.50,'Tennis, Squash, Badminton'),
	...
	(264,19,'Drones',NULL,''),
	(265,24,'Backpacks',NULL,''),
	(266,24,'Briefcases',NULL,''),
	(267,24,'Duffel Bags',NULL,''),
	(268,24,'Suitcases',NULL,''),
	(269,24,'Waterproof Boxes',NULL,''),
	(270,24,'Hard Cases',NULL,''),
	(271,208,'Electronic Items',NULL,''),
	(272,208,'Fabric Items',NULL,''),
	(273,208,'Metal - Non Alu',NULL,''),
	(274,208,'Power Tool - Cordless',NULL,''),
	(275,208,'Power Tool - Corded (mains)',NULL,''),
	(276,208,'Power Tool - Petrol',NULL,''),
	(277,208,'Mixed Plastic / Wood',NULL,''),
	(278,208,'Mixed Plastic / Metal',NULL,''),
	(279,208,'Mixed Plastic / Rubber',NULL,''),
	(280,26,'Cookware',NULL,'Pots, pans, tins, frying pans'),
	(282,232,'Skateboard Helmets',NULL,''),
	(284,19,'Camera Bags',NULL,''),
	(285,33,'Wooden Lawn Games',NULL,'Croquet, Quoits'),
	(286,33,'Plastic Lawn Games',NULL,''),
	(288,149,'Virtual Reality Equipment',NULL,''),
	(289,149,'Wii-Fit',NULL,''),
	(290,34,'Plastic Toys - Generic',NULL,''),
	(291,34,'Wooden Toys - Generic',NULL,''),
	(292,NULL,'Tools',NULL,''),
	(293,292,'Hand Tools',NULL,''),
	(294,292,'Power Tools - Cordless (battery)',NULL,''),
	(295,292,'Power Tools - Corded (mains)',NULL,''),
	(296,292,'Workshop Machinery',NULL,''),
	(297,292,'Electrical Accessory Tools',NULL,'e.g. Lights, Cables'),
	(298,85,'Dehumidifiers',NULL,''),
	(299,292,'Ladders & Metal Steps',NULL,''),
	(300,295,'Jigsaws - Corded',NULL,''),
	(301,295,'Drills - Corded',NULL,''),
	(302,295,'Grinders - Corded',NULL,''),
	(303,294,'Jigsaw - Cordless',NULL,''),
	(304,294,'Drill - Cordless',NULL,''),
	(305,294,'Grinder - Cordless',NULL,''),
	(306,293,'Hammers',NULL,''),
	(307,293,'Hand Tools - Generic metal',NULL,'Pliers, Grips, Rivet guns'),
	(308,293,'Hand Tools - Generic plastic',NULL,'Grip clamps, spirit levels'),
	(309,292,'Automotive Tools',NULL,''),
	(310,292,'Bicycle Tools',NULL,''),
	(311,296,'Air Compressors',NULL,''),
	(312,296,'Drill Presses',NULL,''),
	(313,296,'CNC Machines',NULL,''),
	(314,296,'Lathes',NULL,''),
	(315,296,'Band Saws',NULL,''),
	(316,295,'Power Sanders - Corded',NULL,''),
	(317,295,'Power Planers - Corded',NULL,''),
	(320,294,'Battery Chargers',NULL,''),
	(321,294,'Power Tool Batteries (Li-ion)',NULL,''),
	(322,297,'Work Lights',NULL,''),
	(323,297,'Extension Leads',NULL,''),
	(324,295,'Soldering Irons & Accessories',NULL,''),
	(325,292,'Soldering, Brazing & Welding',NULL,''),
	(326,325,'Brazing torches',NULL,''),
	(327,325,'Welding Equipment',NULL,''),
	(328,295,'Heat Guns',NULL,''),
	(329,54,'Spades, Hoes & Rakes',NULL,''),
	(330,54,'Hose Pipes',NULL,'');
